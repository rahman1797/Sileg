          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Form register <small>for Admin</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">

                    <form class="form-horizontal form-label-left" action="<?php echo base_url();?>c_add/tambah" method="post" >

                      <p>Form ini hanya diperuntukkan me-register Admin baru
                      </p>
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="NIK/NIP">NIK/NIP <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <input type="hidden" name="NoIjazah">
                        </div>
                      </div>
                      <div class="item form-group">
